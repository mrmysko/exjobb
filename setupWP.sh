...
# Get PHP version for FPM configuration
PHP_VERSION=$(php -r "echo PHP_MAJOR_VERSION.'.'.PHP_MINOR_VERSION;")
msg_info "Detected PHP version: ${PHP_VERSION}"
...
openssl req -x509 -newkey rsa:4096 -keyout /etc/apache2/certs/wp-key.pem \
    ...
    -subj "/C=SE/ST=Stockholm/L=Solna/O=${ORGANIZATION}/OU=DD/CN=${SITE_NAME}.${DOMAIN}"
